/**Test Case Name : TC10_OpenCart_SearchandAdd_Iphone
 * Author: Jyothi
 * Date of Creation: 19/04/2021
 * Description: This test case will login into website, search and add iphone to cart
 */
...
public class TC10_OpenCart_SearchandAdd_Iphone extends BaseClass {
	public static Logger logger = LogManager.getLogger(TC10_OpenCart_SearchandAdd_Iphone.class);
