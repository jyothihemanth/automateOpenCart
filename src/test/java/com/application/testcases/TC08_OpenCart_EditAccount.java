 ...
 * Description: This test case will edit the account
 */
...
public class TC08_OpenCart_EditAccount extends BaseClass {
	 
		public static Logger logger = LogManager.getLogger(TC08_OpenCart_EditAccount.class);
		...
		public void Login() throws Exception 
		{
			...
			home.editAccount();
			takeScreenshot("Account edited successfully");
