...
public class TC06_OpenCart_Show_All_Laptops_Notebook_GuestCheckout_Test extends BaseClass {
	public static Logger logger = LogManager.getLogger(TC06_OpenCart_Show_All_Laptops_Notebook_GuestCheckout_Test.class);
...
//		logger.info("user has logged in to openCart website successfully");
		...
		product.OpenCartClickOnGuestCheckOut();
		product.OpenCartFillBillingMandatoryDetails(prop.getProperty("OpenCartBillingFirstName"),prop.getProperty("OpenCartBillingLastName"),
				prop.getProperty("OpenCartBillingemail"),prop.getProperty("OpenCartBillingphone"),prop.getProperty("OpenCartBillingAddress1"),
