/**Test Case Name : TC11_Opencart_Remove_Prod_frmCart_Test
 * Author: Jyothi
 * Date of Creation: 19/04/2021
 * Description: This test case will login into website,ad product and remove the product from the cart
 */
...
public class TC11_Opencart_Remove_Prod_frmCart_Test extends BaseClass {
	...
	public void Login() throws Exception {
		...
		home.OpenCartlaptopsandNotebooksAddProducts();
		//logger.info("user removed product from cart successfully");
		takeScreenshot("Product Removed successfully");
