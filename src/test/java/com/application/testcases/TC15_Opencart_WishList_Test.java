...
/**Test Case Name : TC16_Opencart_WishList_Test
...
public class TC15_Opencart_WishList_Test extends BaseClass {
	public static Logger logger = LogManager.getLogger(TC15_Opencart_WishList_Test.class);
	...
	public void Login() throws Exception 
	{
		...
		home.OpencartverifyfileuploadWishList();
		
		logger.info("product added to cart successfully");
		takeScreenshot("product added to cart successfully");
